...
public class Render {
	...
	private void render() {
		...
		System.out.print("Fish-eye camera... ");
	...
	private void initCameras(int width, int height) {
		...
		plainCamera = new PlainCamera(cameraEyePosition, cameraTarget,
				new Vector3(0, 0, 1), width, height);
		float pi_4 = 0.785398163f;

		pinholeCamera = new PinholeCamera(cameraEyePosition, cameraTarget,
				new Vector3(0, 0, 1f), width, height, pi_4);

		fisheyeCamera = new FisheyeCamera(cameraEyePosition, cameraTarget,
				new Vector3(0, 0, 1), width, height);
...
//		float step = 1;
		...
		sceneKulickyNadDeskou.setLight(0, new Light(new Point3D(1, -1, 1),
				0.4f, new ColorRGB(ColorRGB.red)));
		sceneKulickyNadDeskou.setLight(1, new Light(new Point3D(1, 1, 1), 0.4f,
				new ColorRGB(ColorRGB.green)));
		sceneKulickyNadDeskou.setLight(2, new Light(new Point3D(0, 1, 1), 0.4f,
				new ColorRGB(ColorRGB.blue)));
		sceneKulickyNadDeskou.setLight(3, new Light(new Point3D(0, -1, 1),
				0.4f, new ColorRGB(ColorRGB.white)));
	 ...
	 * &lt;plain|pinhole|fisheye&gt; .... jedna z hodnot definující typ kamery
	 * <br />.
	 * 
	 * @param args
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Usage: Render <screen width> <screen height> <plain|pinhole|fisheye>");
