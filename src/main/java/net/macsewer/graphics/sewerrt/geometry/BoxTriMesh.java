...
public class BoxTriMesh extends TriMesh {
   ...
   private void compute() {
      ...
      Vertex vA = new Vertex(new Point3D(pivot.x + depth / 2, pivot.y - width / 2, pivot.z), null, ColorRGB.white, new Float3());
      vA.setOwner(this);

      Vertex vB = new Vertex(new Point3D(pivot.x + depth / 2, pivot.y + width / 2, pivot.z), null, ColorRGB.white, new Float3());
      vB.setOwner(this);

      Vertex vC = new Vertex(new Point3D(pivot.x - depth / 2, pivot.y + width / 2, pivot.z), null, ColorRGB.white, new Float3());
      vC.setOwner(this);

      Vertex vD = new Vertex(new Point3D(pivot.x - depth / 2, pivot.y - width / 2, pivot.z), null, ColorRGB.white, new Float3());
      vD.setOwner(this);

      Vertex vE = new Vertex(new Point3D(pivot.x + depth / 2, pivot.y - width / 2, pivot.z + height), null, ColorRGB.white, new Float3());
      vE.setOwner(this);

      Vertex vF = new Vertex(new Point3D(pivot.x + depth / 2, pivot.y + width / 2, pivot.z + height), null, ColorRGB.white, new Float3());
      vF.setOwner(this);

      Vertex vG = new Vertex(new Point3D(pivot.x - depth / 2, pivot.y + width / 2, pivot.z + height), null, ColorRGB.white, new Float3());
      vG.setOwner(this);

      Vertex vH = new Vertex(new Point3D(pivot.x - depth / 2, pivot.y - width / 2, pivot.z + height), null, ColorRGB.white, new Float3());
      vH.setOwner(this);
